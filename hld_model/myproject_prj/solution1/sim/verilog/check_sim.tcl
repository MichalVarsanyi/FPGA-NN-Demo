...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         ...
         "rtl.myproject.autotvout_layer7_out_6.dat"
         "rtl.myproject.autotvout_layer7_out_7.dat"
         "rtl.myproject.autotvout_layer7_out_8.dat"
         "rtl.myproject.autotvout_layer7_out_9.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
